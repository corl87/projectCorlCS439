...
My main issue was trying to change the tileset using one scene. The way I got this project to work was to create multiple scenes that pass attributes such as player powerups to each other. I also added a seperate door tile so that I could still use water in my maps. 
